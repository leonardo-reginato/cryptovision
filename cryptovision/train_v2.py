...
def train_model(model, X_gen_train, X_gen_valid, class_weight, epochs=200, early_stop_patience=5, lr_patience=5):
...
def plot_prediction_vs_actual(
    predicted_dataset: DataFrame, num_images: int = 4, save_path: str = None, target:str=None
):
...
def main(**params):
    ...
    #        create_image_dataframe(params["fisbase_dir"], True, [params["model_target"]]),
    #    ]
    ...
    #if invalid_images:
    #    logging.error(f"Found {len(invalid_images)} invalid images. Please check the logs for more details.")
    #    return
    #
    ...
    plot_prediction_vs_actual(pred_df, 25, os.path.join(model_dir, "pred_vs_actual"), params['model_target'])
...
if __name__ == "__main__":
    ...
    params = {
        "train_set": "/Users/leonardo/Library/CloudStorage/GoogleDrive-leonardofonseca.r@gmail.com/My Drive/04_projects/CryptoVision/Data/training/train",
        "test_set": "/Users/leonardo/Library/CloudStorage/GoogleDrive-leonardofonseca.r@gmail.com/My Drive/04_projects/CryptoVision/Data/training/test",
        "model_target": "label",
