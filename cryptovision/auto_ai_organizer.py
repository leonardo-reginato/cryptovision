...
if __name__ == "__main__":
    ...
    organize_images_by_predictions(
        ai=ai,
        image_directory="/Volumes/T7_shield/CryptoVision/Data/others/jeannot_photos/All",
        output_directory="/Volumes/T7_shield/CryptoVision/Data/others/jeannot_photos/cv_organized",
