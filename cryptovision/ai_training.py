...
def train_model(model, X_gen_train, X_gen_valid, class_weight, epochs=200, patience=5):
...
def main(**params):
    ...
    df = pd.concat(
        [
            create_image_dataframe(params["image_dir"]),
            create_image_dataframe(params["fisbase_dir"]),
        ]
...
if __name__ == "__main__":
    ...
    params = {
        "image_dir": "/Volumes/T7_shield/CryptoVision/Clustering/ID2403271942/Clustered_species_dataset",
        "fisbase_dir": "/Volumes/T7_shield/CryptoVision/Misc/google_images_source",
        "model_target": "label",
